        ...
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          <div className="md:flex lg:items-center lg:gap-8 xl:gap-32.5">
            <div className=" md:w-1/2">
              ...
              <p>
                Expert in Shopify, WooCommerce, and WordPress Development.
                Elevate your online business with tailored web solutions,
                seamless user experiences, and innovative designs.
              </p>
              {/* 
             <div className="mt-10">

          ...
          <div className="md:flex items-center gap-8 lg:gap-32.5">
            ...
            >
              <span className="font-medium uppercase text-black dark:text-white">
                Aura Commerce isn’t just a theme; it’s a tool for success.,
              </span>
              <h2 className="relative mb-6 text-3xl font-bold text-black dark:text-white xl:text-hero">
              Built to Elevate Your Brand and Drive Sales
              ...
              <div className="mt-7.5 flex items-center gap-5">
                ...
                <div className="w-3/4">
                  ...
                  Boost engagement with dynamic content and interactive sections.
                  </h3>
                </div>
              </div>
              <div className="mt-7.5 flex items-center gap-5">
                ...
                <div className="w-3/4">
                  <h3 className="mb-0.5 text-metatitle2 text-black dark:text-white">
                  Convert more customers with optimized layouts and sales-driven features.
                  </h3>
                </div>
              </div>
              <div className="mt-7.5 flex items-center gap-5">
                ...
                <div className="w-3/4">
                  <h3 className="mb-0.5 text-metatitle2 text-black dark:text-white">
                  Build trust with testimonials, reviews, and stunning visuals.
                  </h3>
                </div>
              </div>
              <div className="mt-7.5 flex items-center gap-5">
                ...
                <div className="w-3/4">
                  <h3 className="mb-0.5 text-metatitle2 text-black dark:text-white">
                  Scale effortlessly with responsive design and advanced customization.
                  </h3>
                </div>
              </div>
